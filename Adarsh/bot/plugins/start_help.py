...
@StreamBot.on_message((filters.command("start") | filters.regex('𝐬𝐭𝐚𝐫𝐭⚡️')) & filters.private )
async def start(b, m):
        ...
        try:
            ...
            if user.status == "kicked":
             ...
             await StreamBot.send_photo(
                chat_id=m.chat.id,
                photo="https://telegra.ph/file/6bf5418ce30b3b8f89a3a.jpg",
    ...
    await StreamBot.send_photo(
        chat_id=m.chat.id,
        photo ="https://telegra.ph/file/2f766a09b17b9fb68629e.jpg",
        caption =f'Hi {m.from_user.mention(style="md")}!,\nI am Telegram File to Link Generator Bot with Channel support.\nSend me any file and get a direct download link and streamable link.!',
        reply_markup=buttonz)


@StreamBot.on_message((filters.command("help") | filters.regex('𝐡𝐞𝐥𝐩📚')) & filters.private )
...
<b> I also support Channels, add me to you Channel and send any media files and see miracle✨ also send /list to know all commands""",
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("💁‍♂️ 𝘿𝙀𝙑𝙀𝙇𝙊𝙋𝙀𝙍", url="https://telegram.me/CR_0O0")],
                [InlineKeyboardButton("💥 𝗕𝗢𝗧 𝗖𝗛𝗔𝗡𝗡𝗘𝗟", url="https://telegram.me/DynoBots")]
            ]
        )
    )
